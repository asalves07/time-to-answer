namespace :dev do
  ...
  task setup: :environment do
    if Rails.env.development?
      ...
      show_spinner("Cadastrando questões e respostas...") {%x(rails dev:add_question_and_answers)}
    else
  ...
  task add_question_and_answers: :environment do 
  ...
  task add_answers_to_redis: :environment do 
      show_spinner("Adcionando todas as respostas no Redis...") do
